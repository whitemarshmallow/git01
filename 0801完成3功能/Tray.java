...
public class Tray {
    ...
    public Tray(String trayId, String areaId, String trayName, String trayModel, float trayLength, float trayWidth, float trayHeight, String trayBindNode, String trayStartPos, String trayCurrentPos, boolean enableDisable, boolean lockUnlock, float oriX, float oriY) {
        this.trayId = trayId;
        this.areaId = areaId;
