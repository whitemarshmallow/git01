...
//    List<Shelf> findByAreaId(String areaId);
    ...
    @Select("SELECT s.*, n.ori_x, n.ori_y FROM shelf s " +
            "JOIN smap_nodes_data n ON s.shelfBindNode = n.instance_name AND s.areaId = n.area_id " +
    ...
    @Select("<script>" +
            ...
            "</where>" +
            "</script>")
    List<Shelf> findByCriteria(@Param("areaId") String areaId, @Param("filterCriteriaMap") Map<String, Map<String, String>> filterCriteriaMap);
