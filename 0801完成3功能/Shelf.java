...
public class Shelf {
    ...
    public Shelf(String shelfId, String areaId, String shelfName, String shelfModel, float shelfLength, float shelfWidth, float shelfHeight, int shelfLayer, int shelfColumn, int shelfCapacity, String shelfBindNode, String shelfStartPos, String shelfCurrentPos, boolean enableDisable, boolean lockUnlock,float oriX, float oriY) {
