...
public class Mixture {
    ...
    public Mixture(String mixturePerLayer, String mixtureId, String areaId, String mixtureName, String mixtureModel, float mixtureLength, float mixtureWidth, float mixtureHeight, int mixtureLayer, int mixtureColumn, int mixtureCapacity, String mixtureBindNode, String mixtureStartPos, boolean enableDisable, boolean lockUnlock) {
